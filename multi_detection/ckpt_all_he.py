...
class YoloTest(object):
    def __init__(self):
        ...
        self.weight_file = "./checkpoint/yolov3_train_loss=4.8811.ckpt-50"  # ckpt文件地址
...
if __name__ == '__main__':
    ...
    save_dir = "C:/Users/sunyihuan/Desktop/test_jpg_check20191208/normal/detection_checkpoint_1216"  # 图片保存地址
    if not os.path.exists(save_dir): os.mkdir(save_dir)

    layer_error_dir = "C:/Users/sunyihuan/Desktop/test_jpg_check20191208/normal/error_checkpoint_1216"  # 预测结果错误保存地址
    if not os.path.exists(layer_error_dir): os.mkdir(layer_error_dir)

    no_result_dir = "C:/Users/sunyihuan/Desktop/test_jpg_check20191208/normal/no_result_checkpoint_1216"  # 无任何输出结果保存地址
