...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_annotation",
                        default="E:/kx_detection/multi_detection/data/dataset/2020/train0318.txt")
    parser.add_argument("--test_annotation",
                        default="E:/kx_detection/multi_detection/data/dataset/2020/test0318.txt")
    parser.add_argument("--val_annotation",
                        default="E:/kx_detection/multi_detection/data/dataset/2020/val0318.txt")
