...
mnist = input_data.read_data_sets("/home/sunyihuan/sunyihuan_algorithm/data/mnist/", one_hot=True)
...
def train():
    with tf.device("/cpu:0"):
        ...
        with tf.variable_scope(tf.get_variable_scope()):
            for i in range(4):
                with tf.device(assign_to_device('/gpu:{}'.format(i+4), ps_device='/cpu:0')):
