...
__C.TRAIN.ANNOT_PATH            = "./data/dataset/XandOld/train0926_oldAndX1217_cut_pizzatwo_roasted.txt"
...
__C.TRAIN.INITIAL_WEIGHT        = "./checkpoint/yolov3_train_loss=15.7117.ckpt-24"
