...
class YoloPredict(object):
    ...
    def result(self, image_path, save_dir="E:/WLS_originalData/3660camera_data202007/X5_original1_detect"):
...
if __name__ == '__main__':
    ...
    img_root = "E:/WLS_originalData/3660camera_data202007/X5_original1"  # 图片文件地址
    Y = YoloPredict()
    end_time0 = time.time()
    ...
    classes_id22 = {"beefsteak": 0, "cartooncookies": 1, "chickenwings": 2, "chiffoncake6": 3, "chiffoncake8": 24,
