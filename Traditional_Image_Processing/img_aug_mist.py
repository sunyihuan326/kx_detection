...
def img_warm(img_path):
    ...
    img2 = cv2.resize(img2, (800, 600))  # 统一图片大小
    dst = cv2.addWeighted(img1, 0.6, img2, 0.4, 0)  # 图片融合
    return dst
...
def img_dir_aug(img_dir, xml_dir, img_save_dir, xml_save_dir):
    ...
    for img_file in tqdm(os.listdir(img_dir)):
        if img_file.endswith("jpg"):
            ...
            img_name = str(img_file).split(".")[0] + "_warm64" + ".jpg"  # 图片名称
...
if __name__ == "__main__":
    ...
    img_save_dir = "C:/Users/sunyihuan/Desktop/data/warm64"
    xml_save_dir = "C:/Users/sunyihuan/Desktop/data/warm64_annotations"
