...
def aug_drawLine(img_path):
    ...
    for i in range(10):
        ...
        draw_img.line((0, l, 800, l), fill=(34, 139, 34), width=2)
    return np.array(im)
...
if __name__ == "__main__":
    ...
    img_save_dir = "C:/Users/sunyihuan/Desktop/data/line"
    xml_save_dir = "C:/Users/sunyihuan/Desktop/data/line_annotations"
